...
<section class="content">
  ...
  <app-piutang-range></app-piutang-range>

  <div class="row">
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Upload Piutang</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                ...
                <div style="overflow-x: scroll;">
                    <img src="assets/img/excel_piutang.jpg">
                </div>
...
export class PiutangDetailComponent implements OnInit {
  ...
  getData() {
    console.log("get Data");
     ...
     upload() {
        ...
        this.piutangService.uploadXls(formData, this.year, this.month)
                .subscribe(result => {
