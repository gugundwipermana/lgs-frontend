    ...
    <div class="col-md-12">
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <tbody>
                    <tr *ngFor="let item of completes" class="td-click">
                      <td>{{ item.TREG }}</td>
...
export class CompleteTypeComponent implements OnInit {
  ...
  getData() {
    ...
    this.route.params.subscribe(params => {
        ...
        this.completeService.totalByTypeOrder(this.type).subscribe( data => {
