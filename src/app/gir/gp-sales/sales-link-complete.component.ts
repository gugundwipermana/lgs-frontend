...
@Component({
  selector: 'app-sales-link-complete',
  template: `
  ...
  <section class="content-header">
    <h1>
      Sales
      <small>Link Complete</small>
    </h1>
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
      <li><a href="#"><i class="fa fa-dashboard"></i> Sales</a></li>
      <li class="active">Link Complete</li>
    </ol>
  </section>
    ...
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Link Complete</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
...
export class SalesLinkCompleteComponent implements OnInit {
  ...
  getData() {
    ...
    this.salesService.perTregLinkComplete().subscribe(data => {
        this.data = data;
