...
@Component({
  selector: 'app-gir-dashboard1',
  templateUrl: './gir-dashboard1.component.html',
  styleUrls: ['./gir-dashboard1.component.css']
})
export class GirDashboard1Component implements OnInit {
