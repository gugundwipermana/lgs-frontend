...
@Component({
  selector: 'app-project-channel-pl',
  template: `
    ...
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Project Channel Penunjukan Langsung</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                ...
                <img src="assets/img/excel_project_pl.jpg">
                </div>
...
export class ProjectChannelPlComponent implements OnInit {
  ...
  getData() {
    ...
    this.projectChannelService.getPl(this.year, this.month)
        .subscribe(data => { 
            this.data = data;
     ...
     upload() {
        ...
        this.projectChannelService.uploadXls(formData, this.year, this.month, 3)
                .subscribe(result => {
