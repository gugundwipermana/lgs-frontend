...
@Component({
  selector: 'app-gp-revenue-ytd',
  templateUrl: './gp-revenue-ytd.component.html',
  styleUrls: ['./gp-revenue-ytd.component.css']
})
export class GpRevenueYtdComponent implements OnInit {
  ...
  ngOnInit() {
    this.sharedService.emitChange('YTD');
    ...
    this.revenueService.getDetail(this.year, this.start_month, this.end_month, this.param_treg, this.param_witel, this.param_customer, this.param_am)
      .subscribe(data=> {
        ...
        Object.keys(groube).forEach(function(group_by2){
          ...
          myVinyls["TARGET_"+group_by2] = Math.round((target_item/1000000000)*100)/100;
          myVinyls[group_by2] = Math.round((revenue_item/1000000000)*100)/100;
...
var Barchart = function(options){
  ...
  this.draw = function(){
      ...
      for (categ in this.options.data){
          ...
          ctx.font = "12px Arial";
          ctx.fillText(labelText+"M", x, (y - 1));
      ...
      for (categ in this.options.data){
          ...
          // span.style.borderLeft = "10px solid #ffffff"; //+this.colors[barIndex%this.colors.length];
          span.style.backgroundColor = this.colors[barIndex%this.colors.length];
          ...
          span.style.paddingLeft = "20px !important";
          span.style.borderRight = "10px solid white";
