...
export class OgpDetailComponent implements OnInit {
  ...
  getData() {
    ...
    this.route.params.subscribe(params => {
        ...
        this.ogpService.detailByTypeOrder(this.treg, this.type, this.status).subscribe( data => {
