...
@Component({
  selector: 'app-end-contract-detail',
  template: `
...
export class EndContractDetailComponent implements OnInit {
  ...
  getData() {
    ...
    this.route.params.subscribe(params => {
        ...
        this.endContractService.detailByTypeOrder(this.treg, this.type, this.status).subscribe( data => {
